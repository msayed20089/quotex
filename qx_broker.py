...
def main():
    """الدالة الرئيسية لتشغيل البوت على Railway"""
    try:
        # انتظار بسيط لضمان استقرار النظام
        logger.info("⏳ جاري تهيئة النظام على Railway...")
        time.sleep(5)
        
        logger.info("🚀 بدء تشغيل بوت التداول 24 ساعة على Railway...")
        ...
        # البقاء في حلقة رئيسية بسيطة
        while True:
            time.sleep(60)
            logger.debug("🔄 النظام يعمل بشكل طبيعي...")
